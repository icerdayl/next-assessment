...
export default function Home() {
  return (
    <>
      <div className="flex justify-evenly items-center flex-1 my-30 font-sans ">
        <div className="flex">
          <main className="flex flex-col">
            ...
            className="border-purple-600 border-2 text-3xl rounded-2xl px-10 py-5 font-bold cursor-pointer hover:text-black transition duration-700 ease-initial mt-7 btn-style507">
